  ...
  return (
    <div className="min-h-screen bg-white text-[#191A23]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 mb-24 relative">
        ...
        {/* Decorative image – floats freely in front of the box */}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`w-10 h-10 rounded-full border-2 border-[#191A23] flex items-center justify-center shrink-0 transition-colors ${isOpen ? "bg-[#191A23]" : "bg-white"
                      }`}
                  >
                    {isOpen ? (
                      <Minus className="w-5 h-5 text-white" />
                    ) : (
                      <Plus className="w-5 h-5 text-[#191A23]" />
                    )}
                  </div>
                </button>
                {isOpen && (
