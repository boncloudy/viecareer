      ...
      <aside className="fixed left-0 top-0 h-screen w-[220px] bg-[#0F172A] text-white flex flex-col z-50">
        ...
        <div className="p-4">
          <div className="bg-white/5 rounded-xl p-4 border border-white/10">
            <p className="text-[10px] text-[#5378EF] uppercase tracking-wider font-semibold mb-1 flex items-center gap-1">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-teal-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#5378EF]"></span>
              </span>
              System Status
            </p>
      ...
      <div className="flex-1 ml-[220px] flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 sticky top-0 z-20">
          <div className="flex items-center gap-2">
            <ShieldAlert className="w-5 h-5 text-[#5378EF]" />
